...
type FutureInfo struct {
	...
	Security           *Qot_Common.Security `protobuf:"bytes,2,req,name=security" json:"security,omitempty"`                       // 合约代码
	...
	Owner              *Qot_Common.Security `protobuf:"bytes,5,opt,name=owner" json:"owner,omitempty"`                             //标的股 股票期货和股指期货才有该字段
	...
	Origin             *Qot_Common.Security `protobuf:"bytes,18,opt,name=origin" json:"origin,omitempty"`                          //实际合约代码
}
...
func (x *FutureInfo) GetSecurity() *Qot_Common.Security {
	if x != nil {
		return x.Security
	}
	return nil
...
func (x *FutureInfo) GetOwner() *Qot_Common.Security {
	if x != nil {
		return x.Owner
	}
	return nil
...
func (x *FutureInfo) GetOrigin() *Qot_Common.Security {
	if x != nil {
		return x.Origin
	}
	return nil
...
type C2S struct {
	...
	SecurityList []*Qot_Common.Security `protobuf:"bytes,1,rep,name=securityList" json:"securityList,omitempty"` //股票列表
}
...
var file_Qot_GetFutureInfo_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x79, 0x6d, 0x6d, 0x73, 0x63, 0x2f,
	0x66, 0x75, 0x74, 0x75, 0x34, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f,
	0x51, 0x6f, 0x74, 0x5f, 0x47, 0x65, 0x74, 0x46, 0x75, 0x74, 0x75, 0x72, 0x65, 0x49, 0x6e, 0x66,
	0x6f,
}
...
var file_Qot_GetFutureInfo_proto_goTypes = []interface{}{
	...
	(*Qot_Common.Security)(nil), // 6: Qot_Common.Security
}

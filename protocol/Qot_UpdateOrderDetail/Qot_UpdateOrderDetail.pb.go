...
type S2C struct {
	...
	OrderDetailAsk *Qot_Common.OrderDetail `protobuf:"bytes,2,req,name=orderDetailAsk" json:"orderDetailAsk,omitempty"` //卖盘
	OrderDetailBid *Qot_Common.OrderDetail `protobuf:"bytes,3,req,name=orderDetailBid" json:"orderDetailBid,omitempty"` //买盘
}
...
func (x *S2C) GetOrderDetailAsk() *Qot_Common.OrderDetail {
	if x != nil {
...
func (x *S2C) GetOrderDetailBid() *Qot_Common.OrderDetail {
	if x != nil {
...
var file_Qot_UpdateOrderDetail_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x5f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x2e, 0x53, 0x32, 0x43, 0x52, 0x03, 0x73, 0x32, 0x63, 0x42, 0x39, 0x5a,
	0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x79, 0x6d, 0x6d,
	0x73, 0x63, 0x2f, 0x66, 0x75, 0x74, 0x75, 0x34, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63,
	0x6f, 0x6c, 0x2f, 0x51, 0x6f, 0x74, 0x5f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c,
}
...
var file_Qot_UpdateOrderDetail_proto_goTypes = []interface{}{
	...
	(*Qot_Common.OrderDetail)(nil), // 3: Qot_Common.OrderDetail
}

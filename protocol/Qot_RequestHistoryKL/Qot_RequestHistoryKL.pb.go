...
type C2S struct {
	...
	Security         *Qot_Common.Security `protobuf:"bytes,3,req,name=security" json:"security,omitempty"`                  //股票市场以及股票代码
...
type S2C struct {
	...
	KlList     []*Qot_Common.KLine  `protobuf:"bytes,2,rep,name=klList" json:"klList,omitempty"`         //K线数据
...
func (x *S2C) GetKlList() []*Qot_Common.KLine {
	if x != nil {
		return x.KlList
	}
	return nil
...
var file_Qot_RequestHistoryKL_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x73, 0x32, 0x63, 0x42, 0x4d, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75, 0x74,
	0x75, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x36, 0x67, 0x69,
...
var file_Qot_RequestHistoryKL_proto_goTypes = []interface{}{
	...
	(*Qot_Common.KLine)(nil),    // 5: Qot_Common.KLine
}

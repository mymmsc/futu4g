...
type CodeChangeInfo struct {
	...
	Security           *Qot_Common.Security `protobuf:"bytes,2,req,name=security" json:"security,omitempty"`                       //主代码，在创业板转主板中表示主板
	RelatedSecurity    *Qot_Common.Security `protobuf:"bytes,3,req,name=relatedSecurity" json:"relatedSecurity,omitempty"`         //关联代码，在创业板转主板中表示创业板，在剩余事件中表示临时代码
...
func (x *CodeChangeInfo) GetSecurity() *Qot_Common.Security {
	if x != nil {
		return x.Security
	}
	return nil
...
func (x *CodeChangeInfo) GetRelatedSecurity() *Qot_Common.Security {
	if x != nil {
...
type C2S struct {
	...
	SecurityList   []*Qot_Common.Security `protobuf:"bytes,2,rep,name=securityList" json:"securityList,omitempty"`     //根据股票筛选
...
var file_Qot_GetCodeChange_proto_rawDesc = []byte{
	...
	0x64, 0x10, 0x03, 0x42, 0x4a, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75, 0x74, 0x75, 0x2e,
	0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x79, 0x6d, 0x6d, 0x73, 0x63, 0x2f, 0x66, 0x75,
	0x74, 0x75, 0x34, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x51, 0x6f,
	0x74, 0x5f, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65,
}

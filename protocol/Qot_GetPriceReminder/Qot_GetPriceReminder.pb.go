...
func (x *PriceReminder) GetSecurity() *Qot_Common.Security {
	if x != nil {
		return x.Security
	}
	return nil
...
type C2S struct {
	...
	Security *Qot_Common.Security `protobuf:"bytes,1,opt,name=security" json:"security,omitempty"` // 查询股票下的到价提醒项，security和market二选一，都存在的情况下security优先。
...
var file_Qot_GetPriceReminder_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x65, 0x6d, 0x69, 0x6e, 0x64, 0x65, 0x72,
}

...
func (x *MarginRatioInfo) GetSecurity() *Qot_Common.Security {
	if x != nil {
		return x.Security
	}
	return nil
...
type C2S struct {
	...
	SecurityList []*Qot_Common.Security `protobuf:"bytes,2,rep,name=securityList" json:"securityList,omitempty"` //股票
}
...
var file_Trd_GetMarginRatio_proto_rawDesc = []byte{
	...
	0x43, 0x52, 0x03, 0x73, 0x32, 0x63, 0x42, 0x4b, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75,
	0x74, 0x75, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x34, 0x67,
	...
	0x2f, 0x54, 0x72, 0x64, 0x5f, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x52, 0x61,
	0x74, 0x69, 0x6f,
}
...
var file_Trd_GetMarginRatio_proto_goTypes = []interface{}{
	...
	(*Trd_Common.TrdHeader)(nil), // 6: Trd_Common.TrdHeader
}

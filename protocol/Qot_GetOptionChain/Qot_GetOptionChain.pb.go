...
type C2S struct {
	...
	Owner           *Qot_Common.Security `protobuf:"bytes,1,req,name=owner" json:"owner,omitempty"`                      //期权标的股，目前仅支持传入港美正股以及恒指国指
...
type OptionItem struct {
	...
	Call *Qot_Common.SecurityStaticInfo `protobuf:"bytes,1,opt,name=call" json:"call,omitempty"` //看涨期权，不一定有该字段，由请求条件决定
	Put  *Qot_Common.SecurityStaticInfo `protobuf:"bytes,2,opt,name=put" json:"put,omitempty"`   //看跌期权，不一定有该字段，由请求条件决定
}
...
func (x *OptionItem) GetCall() *Qot_Common.SecurityStaticInfo {
	if x != nil {
		return x.Call
	}
	return nil
...
func (x *OptionItem) GetPut() *Qot_Common.SecurityStaticInfo {
	if x != nil {
		return x.Put
	}
	return nil
...
var file_Qot_GetOptionChain_proto_rawDesc = []byte{
	...
	0x02, 0x42, 0x4b, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75, 0x74, 0x75, 0x2e, 0x6f, 0x70,
	0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x79, 0x6d, 0x6d, 0x73, 0x63, 0x2f, 0x66, 0x75, 0x74, 0x75,
	0x34, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x51, 0x6f, 0x74, 0x5f,
	0x47, 0x65, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69, 0x6e,
}
...
var file_Qot_GetOptionChain_proto_goTypes = []interface{}{
	...
	(*Qot_Common.Security)(nil),           // 8: Qot_Common.Security
	(*Qot_Common.SecurityStaticInfo)(nil), // 9: Qot_Common.SecurityStaticInfo
}

...
type S2C struct {
	...
	Header     *Trd_Common.TrdHeader  `protobuf:"bytes,1,req,name=header" json:"header,omitempty"`         //交易公共参数头
	MaxTrdQtys *Trd_Common.MaxTrdQtys `protobuf:"bytes,2,opt,name=maxTrdQtys" json:"maxTrdQtys,omitempty"` //最大可交易数量结构
}
...
func (x *S2C) GetMaxTrdQtys() *Trd_Common.MaxTrdQtys {
	if x != nil {
		return x.MaxTrdQtys
	}
	return nil
...
var file_Trd_GetMaxTrdQtys_proto_rawDesc = []byte{
	...
	0x47, 0x65, 0x74, 0x4d, 0x61, 0x78, 0x54, 0x72, 0x64, 0x51, 0x74, 0x79, 0x73,
}
...
var file_Trd_GetMaxTrdQtys_proto_goTypes = []interface{}{
	...
	(*Trd_Common.MaxTrdQtys)(nil), // 5: Trd_Common.MaxTrdQtys
}

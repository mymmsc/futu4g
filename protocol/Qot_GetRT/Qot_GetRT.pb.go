...
type S2C struct {
	...
	Security *Qot_Common.Security    `protobuf:"bytes,1,req,name=security" json:"security,omitempty"` //股票
	RtList   []*Qot_Common.TimeShare `protobuf:"bytes,2,rep,name=rtList" json:"rtList,omitempty"`     //分时点
}
...
var file_Qot_GetRT_proto_rawDesc = []byte{
	...
	0x54, 0x2e, 0x53, 0x32, 0x43, 0x52, 0x03, 0x73, 0x32, 0x63, 0x42, 0x42, 0x0a, 0x13, 0x63, 0x6f,
	0x6d, 0x2e, 0x66, 0x75, 0x74, 0x75, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70,
	0x62, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x79,
	0x6d, 0x6d, 0x73, 0x63, 0x2f, 0x66, 0x75, 0x74, 0x75, 0x34, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x51, 0x6f, 0x74, 0x5f, 0x47, 0x65, 0x74, 0x52, 0x54,
}
...
var file_Qot_GetRT_proto_goTypes = []interface{}{
	...
	(*Qot_Common.TimeShare)(nil), // 5: Qot_Common.TimeShare
}

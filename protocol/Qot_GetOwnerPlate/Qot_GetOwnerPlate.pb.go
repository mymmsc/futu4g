...
type SecurityOwnerPlate struct {
	...
	PlateInfoList []*Qot_Common.PlateInfo `protobuf:"bytes,2,rep,name=plateInfoList" json:"plateInfoList,omitempty"` //所属板块
}
...
func (x *SecurityOwnerPlate) GetSecurity() *Qot_Common.Security {
	if x != nil {
		return x.Security
	}
	return nil
...
func (x *SecurityOwnerPlate) GetPlateInfoList() []*Qot_Common.PlateInfo {
	if x != nil {
...
var file_Qot_GetOwnerPlate_proto_rawDesc = []byte{
	...
	0x5f, 0x47, 0x65, 0x74, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x50, 0x6c, 0x61, 0x74, 0x65,
}
...
var file_Qot_GetOwnerPlate_proto_goTypes = []interface{}{
	...
	(*Qot_Common.PlateInfo)(nil), // 6: Qot_Common.PlateInfo
}
